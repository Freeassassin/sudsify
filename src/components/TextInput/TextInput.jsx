...
const TextInput = ({
  ...
  return (
    ...
    >
      <div
        className={
          "text-input-title-container" +
          (isDisabled ? " text-input-title-container-disabled" : "")
        }
      >
        {label !== undefined ? (
          <p className="text-input-title">{label}</p>
        ) : (
          <></>
        )}
        {isRequiredInput !== undefined &&
      ...
      {errorFeedback ? (
        <p className="text-input-error-message">{errorFeedback}</p>
      ) : (
        <></>
      )}
      {description ? (
